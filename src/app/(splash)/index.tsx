    ...
    <LinearGradient colors={['#000000', '#0a0a0f', '#000000']} style={styles.container}>
      ...
      <View style={styles.topSection}>
        <Animated.View entering={FadeInDown.delay(300).duration(800).springify()} style={styles.iconWrap}>
          <LinearGradient colors={[GREEN, GREEN_DARK]} style={styles.iconBg}>
            <Ionicons name="thunderstorm" size={48} color="#000" />
          </LinearGradient>
        </Animated.View>
      </View>
      ...
      <View style={styles.bottomSection}>
        <Animated.View entering={FadeInUp.delay(500).duration(800).springify()}>
          <ThemedText style={styles.title}>Complete Tasks{'\n'}Earn Rewards</ThemedText>
          <ThemedText style={styles.subtitle}>
            Do simple social media tasks, connect your accounts, and earn points that you can withdraw anytime.
          </ThemedText>
        </Animated.View>
        ...
        <Animated.View entering={FadeInUp.delay(800).duration(600)}>
          <Pressable onPress={() => router.push('/(splash)/splash-2')}>
            <LinearGradient
