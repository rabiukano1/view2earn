    ...
    <LinearGradient colors={['#000000', '#0a0a0f', '#000000']} style={styles.container}>
      ...
      <View style={styles.bottomSection}>
        <Animated.View entering={FadeInUp.delay(500).duration(800).springify()}>
          <ThemedText style={styles.title}>Complete Challenges{'\n'}Earn Big Rewards</ThemedText>
          <ThemedText style={styles.subtitle}>
            Take on daily quizzes, skill challenges, and social tasks to level up your knowledge and earn real rewards.
          </ThemedText>
        </Animated.View>
        ...
        <Animated.View entering={FadeInUp.delay(800).duration(600)} style={styles.buttonColumn}>
          <Pressable onPress={() => router.replace('/(auth)/sign-up')}>
            <LinearGradient
          ...
          <Animated.View entering={FadeIn.delay(1000).duration(600)}>
            <Pressable onPress={() => router.replace('/(auth)/sign-in')}>
              <ThemedText style={styles.loginLink}>I already have an account</ThemedText>
            </Pressable>
          </Animated.View>
        </Animated.View>
      </View>
